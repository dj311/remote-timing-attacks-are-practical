...
## Status
Log:
  * 2020-03-30 :: 3ee49d96822288b3a95d18256e7fc50973c18705 [🔗](https://github.com/dj311/remote-timing-attacks-are-practical/commit/3ee49d96822288b3a95d18256e7fc50973c18705) :: I've added logging in OpenSSL to indicate whether or not it blinds the decryption. Running a quick test confirms that blinding is now off. I've also disabled Nagle's algorithm on the client side. Next task is to re-run the simulations and see if results improve.
